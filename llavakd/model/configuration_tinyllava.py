...
from llavakd.utils.constants import *
...
class TinyLlavaConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.teacher_pretrained_dir=teacher_pretrained_dir
        self.teacher_pretrained_name=teacher_pretrained_name
    ...
    def load_from_config(self, config):
        ...
        self.teacher_pretrained_dir = getattr(config, 'teacher_pretrained_dir',  'teacher_pretrained_ckpt')
        self.teacher_pretrained_name = getattr(config, 'teacher_pretrained_name',  'tiny-llava-Qwen1.5-4B-siglip-so400m-patch14-384-base-')
