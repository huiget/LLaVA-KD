...
class ModelArguments:
    ...
    # add teacher—related arguments
    teacher_pretrained_dir: Optional[str] = field(default='')
    teacher_pretrained_name: Optional[str] = field(default='')
...
class DataArguments:
    ...
    image_size_resize: Optional[int] = field(default=768)
